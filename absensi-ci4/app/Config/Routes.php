...
$routes->add('/waktu', 'Home::getWaktu');
...
$routes->group('shift', ['filter' => 'role:admin,head'], function ($routes) {
    $routes->get('/', 'Shift::index');
    $routes->post('store', 'Shift::store');
    $routes->get('edit/(:num)', 'Shift::edit/$1');
    $routes->post('update', 'Shift::update');
    $routes->add('delete/(:num)', 'Shift::delete/$1');
    $routes->get('setting', 'Shift::settingShift');
    $routes->post('setting/store', 'Shift::storeSettingShift');
});

// $routes->get('/setting-shift', 'Shift::settingShift', ['filter' => 'role:admin,head']);