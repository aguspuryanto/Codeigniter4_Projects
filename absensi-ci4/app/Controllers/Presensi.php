...
class Presensi extends BaseController
{
    ...
    public function laporanHarianExcel()
    {
        ...
        $worksheet->setCellValue('I6', 'SHIFT');
        ...
        if (!empty($data_presensi)) {
            foreach ($data_presensi as $data) {
                ...
                $worksheet->setCellValue('I' . $data_start_row, $data->nama_shift . ' (' . $data->jam_mulai . ' - ' . $data->jam_selesai . ')');
    ...
    public function laporanBulananExcel()
    {
        ...
        $worksheet->getStyle('A6:I6')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $worksheet->getStyle('A6:I6')->getFont()->setBold(true);
        $worksheet->getStyle('A1')->getFont()->setBold(true);
        $worksheet->getStyle('A1')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $worksheet->getStyle('A1')->getFill()
